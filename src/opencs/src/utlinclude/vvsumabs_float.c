#ifndef __vvsumabs_float_SOURCE_INCLUDED
#define __vvsumabs_float_SOURCE_INCLUDED
/* vvsumabs_float.c
 *
 *****************************************************************************************
 *
 ...
 *    $Id: vvsumabs_float.c 12 2012-12-19 18:27:58Z dehning $
 *
 *****************************************************************************************
 */
#include "stdheader.h"
...
C_FUNC_PREFIX
void vvsumabs_float(const float *v, int n, double *vsum, int vdim)
{
   int i;
