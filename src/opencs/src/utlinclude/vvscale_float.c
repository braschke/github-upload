#ifndef __vvscale_float_SOURCE_INCLUDED
#define __vvscale_float_SOURCE_INCLUDED
/* vvscale_float.c
 *
 *****************************************************************************************
 *
 ...
 *    $Id: vvscale_float.c 12 2012-12-19 18:27:58Z dehning $
 *
 *****************************************************************************************
 */
#include "stdheader.h"
...
C_FUNC_PREFIX
float *vvscale_float(float *buf, const int n, const float *scale, const int vdim)
{
   float *v = buf;
   int i;
