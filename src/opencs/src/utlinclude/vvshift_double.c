#ifndef __vvshift_double_SOURCE_INCLUDED
#define __vvshift_double_SOURCE_INCLUDED
/* vvshift_double.c
 *
 *****************************************************************************************
 *
 ...
 *    $Id: vvshift_double.c 12 2012-12-19 18:27:58Z dehning $
 *
 *****************************************************************************************
 */
#include "stdheader.h"
...
C_FUNC_PREFIX
double *vvshift_double(double *buf, int n, const double *shift, int vdim)
{
   double *v = buf;
   int i;
