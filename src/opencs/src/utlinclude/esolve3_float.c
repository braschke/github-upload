#ifndef esolve3_float_SOURCE_INCLUDED
#define esolve3_float_SOURCE_INCLUDED
/* esolve3_float.c
 *
 *****************************************************************************************
 *
 ...
 *    $Id: esolve3_float.c 1593 2013-09-27 15:52:45Z dehning $
 *
 *****************************************************************************************
 */
#include "stdheader.h"
...
C_FUNC_PREFIX
float esolve3_float(const float *A, const float b[3], float x[3])
{
   float det = S_DET3(A11,A12,A13,
                      A21,A22,A23,
                      A31,A32,A33);
