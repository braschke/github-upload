...
#include "meanVelocityForceABS.H"
...
namespace fv
{
    defineTypeNameAndDebug(meanVelocityForceABS, 0);

    addToRunTimeSelectionTable
    (
        option,
        meanVelocityForceABS,
        dictionary
    );
}
}
...
void Foam::fv::meanVelocityForceABS::writeProps
(
    const scalar gradP
) const
{
...
Foam::fv::meanVelocityForceABS::meanVelocityForceABS
(
    ...
    voidFracPtr_(0)
{
    ...
    // preload fields into registry
    voidFrac();
}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
const Foam::volScalarField& Foam::fv::meanVelocityForceABS::voidFrac()
{
...
Foam::scalar Foam::fv::meanVelocityForceABS::magUbarAve
(
...
void Foam::fv::meanVelocityForceABS::correct(volVectorField& U)
{
...
void Foam::fv::meanVelocityForceABS::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
void Foam::fv::meanVelocityForceABS::constrain
(
    fvMatrix<vector>& eqn,
    const label
)
